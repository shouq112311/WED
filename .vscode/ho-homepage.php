...
<section id="aboutus" class="about">
    <div class="main">
        ...
        <div class="about-text">
            ...
            <p style="font-size:22px; width: 550px;">Trust and safety sets Housekeeper apart from the other Housekeepers sites. You’ll get the quickest response from Housekeeper in your area.<br> LuxuryTime provides you with Housekeeper reviews written by Homeowners.</p>            <p> </p>
        </div>
    </div>
</section>
</div>
